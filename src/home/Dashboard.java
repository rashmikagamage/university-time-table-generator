...
public class Dashboard extends JFrame {
	...
	public Dashboard() {
		...
		JButton btnWorkingDays = new JButton("Working Days and Timeslots");
		...
		btnWorkingDays.setBackground(new Color(25, 25, 112));
		btnWorkingDays.setBounds(703, 397, 211, 53);
		contentPane.add(btnWorkingDays);
		...
		btnGenerateTimetable.setBounds(410, 453, 211, 53);
