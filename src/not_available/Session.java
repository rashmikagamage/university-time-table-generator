...
public class Session extends JFrame {
	 ...
	 */
	public Session() {
		SessionDataConnection l = new SessionDataConnection();
		...
		JLabel labelName = new JLabel("Select Session");
		...
		JLabel lblStudent = new JLabel("Sessions");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Duration==0) {
					...
					SessionDataConnection g = new SessionDataConnection();
