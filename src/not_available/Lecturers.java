...
import Tags.TagsDataConnection;
import javafx.scene.control.DatePicker;
import sprint2.DateLabelFormatter;

import javax.swing.JButton;

public class Lecturers extends JFrame {
	...
	public Lecturers() {
		...
		LecDataConnection l = new LecDataConnection();
		ArrayList<String> lecs = l.getData();
		String arr[] = new String[lecs.size()];
		...
		JLabel labelName = new JLabel("Select Lecturer");
		...
		JLabel lblStudent = new JLabel("Lecturers");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				lecturer = String.valueOf(lecsCb.getSelectedItem());
				...
				if(Duration==0) {
					...
					LecDataConnection l = new LecDataConnection();
					l.addData(lecturer,selectedDate.toString(), Duration);
					JOptionPane.showMessageDialog(null,
						    "Allocated!");
		...
		btnNewButton.setBounds(597, 407, 123, 33);
